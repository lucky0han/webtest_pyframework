...
from driver.socketapi.basesocketserver import BaseSocketServer
from common.LogTool import logger
from driver.socketapi.common.sqlitecommonbase import SqliteCommonBase
from driver.socketapi.common.sqlitetool import SqliteTool
...
def args_parser():
    ...
    parser.add_argument("-a", "--address", type=str, default='localhost',
                        help="Mock testdata submit port")
